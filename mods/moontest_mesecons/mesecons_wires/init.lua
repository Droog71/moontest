...
local function register_wires()
	...
	while true do
		...
		local meseconspec_off = { conductor = {
			...
			onstate = "moontest_mesecons:wire_"..nodeid.."_on"
		}}

		local meseconspec_on = { conductor = {
			rules = rules,
			state = mesecon.state.on,
			offstate = "moontest_mesecons:wire_"..nodeid.."_off"
		}}
		...
		mesecon.register_node(":moontest_mesecons:wire_"..nodeid, {
...
minetest.register_craft({
	type = "cooking",
	output = "moontest_mesecons:wire_00000000_off 2",
...
minetest.register_craft({
	type = "cooking",
	output = "moontest_mesecons:wire_00000000_off 18",
...
minetest.register_craft({
	type = "cooking",
	output = "moontest_mesecons:wire_00000000_off 162",
	recipe = "default:mese",
	cooktime = 30,
})
