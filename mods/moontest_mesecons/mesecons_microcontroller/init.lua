...
for c = 0, 1 do
for d = 0, 1 do
local nodename = "moontest_mesecons_microcontroller:microcontroller"..tostring(d)..tostring(c)..tostring(b)..tostring(a)
...
if nodename ~= "moontest_mesecons_microcontroller:microcontroller0000" then
	mesecons.receptor = {
...
minetest.register_node(nodename, {
	...
	walkable = true,
	groups = groups,
	drop = "moontest_mesecons_microcontroller:microcontroller0000 1",
	selection_box = {
		type = "fixed",
...
if minetest.get_modpath("moontest_mesecons_luacontroller") then
	minetest.register_craft({
		type = "shapeless",
		output = "moontest_mesecons_microcontroller:microcontroller0000",
		recipe = {"moontest_mesecons_luacontroller:luacontroller0000"},
	})
	minetest.register_craft({
		type = "shapeless",
		output = "moontest_mesecons_luacontroller:luacontroller0000",
		recipe = {"moontest_mesecons_microcontroller:microcontroller0000"},
	})
else
	minetest.register_craft({
		output = 'craft "moontest_mesecons_microcontroller:microcontroller0000" 2',
		recipe = {
			{'moontest_mesecons_materials:silicon', 'moontest_mesecons_materials:silicon', 'group:mesecon_conductor_craftable'},
			{'moontest_mesecons_materials:silicon', 'moontest_mesecons_materials:silicon', 'group:mesecon_conductor_craftable'},
...
yc.update = function(pos)
	...
	if (mesecon.do_overheat(pos)) then
		...
		minetest.add_item(pos, "moontest_mesecons_microcontroller:microcontroller0000")
	end
...
yc.action = function(pos, L) --L-->Lvirtual
	...
	local name = "moontest_mesecons_microcontroller:microcontroller"
