...
mesecon.register_node("moontest_mesecons_receiver:receiver", {
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = "facedir",
	...
	drop = "moontest_mesecons:wire_00000000_off",
	sounds = nil,
}, {
	tiles = {
	...
	mesecons = {conductor = {
		...
		onstate = "moontest_mesecons_receiver:receiver_on"
	}}
}, {
	tiles = {
		"receiver_top_on.png",
	...
	mesecons = {conductor = {
		...
		rules = receiver_get_rules,
		offstate = "moontest_mesecons_receiver:receiver_off"
	}}
})

mesecon.register_node("moontest_mesecons_receiver:receiver_up", {
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = "facedir",
	is_ground_content = false,
	...
	mesecons = {conductor = {
		...
		rules = {{x=1, y=0, z=0},
			...
			{x=0,  y=1, z=0},
			{x=0,  y=2, z=0}},
		onstate = "moontest_mesecons_receiver:receiver_up_on"
	}}
}, {
	...
	mesecons = {conductor = {
		...
		rules = {{x=1, y=0, z=0},
			...
			{x=0,  y=1, z=0},
			{x=0,  y=2, z=0}},
		offstate = "moontest_mesecons_receiver:receiver_up_off"
	}}
})

mesecon.register_node("moontest_mesecons_receiver:receiver_down", {
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = "facedir",
	is_ground_content = false,
	...
	mesecons = {conductor = {
		...
		rules = {{x=1,y=0, z=0},
			...
			{x=0, y=0, z=-1},
			{x=0, y=-2,z=0}},
		onstate = "moontest_mesecons_receiver:receiver_down_on"
	}}
}, {
	tiles = {"mesecons_wire_on.png"},
	mesecons = {conductor = {
		...
		rules = {{x=1,y=0, z=0},
			...
			{x=0, y=0, z=-1},
			{x=0, y=-2,z=0}},
		offstate = "moontest_mesecons_receiver:receiver_down_off"
	}}
})
...
function mesecon.receiver_get_pos_from_rcpt(pos, param2)
	...
	local rcvtype = "moontest_mesecons_receiver:receiver_off"
	...
	elseif dir.y == -1 then
		...
		rcvtype = "moontest_mesecons_receiver:receiver_up_off"
	elseif dir.y == 1 then
		rules = mesecon.rotate_rules_down(rules)
		rcvtype = "moontest_mesecons_receiver:receiver_down_off"
	end
...
function mesecon.receiver_place(rcpt_pos)
	...
	if string.find(nn.name, "moontest_mesecons:wire_") ~= nil then
...
function mesecon.receiver_remove(rcpt_pos, dugnode)
	...
	local nn = minetest.get_node(pos)
	if string.find(nn.name, "moontest_mesecons_receiver:receiver_") ~= nil then
		local node = {name = "moontest_mesecons:wire_00000000_off"}
...
minetest.register_on_placenode(function (pos, node)
	if string.find(node.name, "moontest_mesecons:wire_") ~= nil then
		local rules = {	{x = 2,  y = 0,  z = 0},
				{x =-2,  y = 0,  z = 0},
				{x = 0,  y = 0,  z = 2},
				{x = 0,  y = 0,  z =-2},
