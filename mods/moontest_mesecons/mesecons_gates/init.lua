...
local function register_gate(name, inputnumber, assess, recipe, description)
	...
	local basename = "moontest_mesecons_gates:"..name
...
register_gate("diode", 1, function (input) return input end,
	{{"moontest_mesecons:mesecon", "moontest_mesecons_torch:mesecon_torch_on", "moontest_mesecons_torch:mesecon_torch_on"}},
	"Diode")

register_gate("not", 1, function (input) return not input end,
	{{"moontest_mesecons:mesecon", "moontest_mesecons_torch:mesecon_torch_on", "moontest_mesecons:mesecon"}},
	"NOT Gate")

register_gate("and", 2, function (val1, val2) return val1 and val2 end,
	{{"moontest_mesecons:mesecon", "", ""},
	 {"", "moontest_mesecons_materials:silicon", "moontest_mesecons:mesecon"},
	 {"moontest_mesecons:mesecon", "", ""}},
	"AND Gate")

register_gate("nand", 2, function (val1, val2) return not (val1 and val2) end,
	{{"moontest_mesecons:mesecon", "", ""},
	 {"", "moontest_mesecons_materials:silicon", "moontest_mesecons_torch:mesecon_torch_on"},
	 {"moontest_mesecons:mesecon", "", ""}},
	"NAND Gate")

register_gate("xor", 2, function (val1, val2) return (val1 or val2) and not (val1 and val2) end,
	{{"moontest_mesecons:mesecon", "", ""},
	 {"", "moontest_mesecons_materials:silicon", "moontest_mesecons_materials:silicon"},
	 {"moontest_mesecons:mesecon", "", ""}},
	"XOR Gate")

register_gate("nor", 2, function (val1, val2) return not (val1 or val2) end,
	{{"moontest_mesecons:mesecon", "", ""},
	 {"", "moontest_mesecons:mesecon", "moontest_mesecons_torch:mesecon_torch_on"},
	 {"moontest_mesecons:mesecon", "", ""}},
	"NOR Gate")

register_gate("or", 2, function (val1, val2) return (val1 or val2) end,
	{{"moontest_mesecons:mesecon", "", ""},
	 {"", "moontest_mesecons:mesecon", "moontest_mesecons:mesecon"},
	 {"moontest_mesecons:mesecon", "", ""}},
	"OR Gate")
