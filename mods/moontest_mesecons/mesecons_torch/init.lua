...
minetest.register_craft({
	output = "moontest_mesecons_torch:mesecon_torch_on 4",
	recipe = {
...
minetest.register_node("moontest_mesecons_torch:mesecon_torch_off", {
	drawtype = "torchlike",
	...
	drop = "moontest_mesecons_torch:mesecon_torch_on",
	sounds = nil,
	mesecons = {receptor = {
...
minetest.register_node("moontest_mesecons_torch:mesecon_torch_on", {
	drawtype = "torchlike",
...
minetest.register_abm({
	nodenames = {"moontest_mesecons_torch:mesecon_torch_off","moontest_mesecons_torch:mesecon_torch_on"},
	interval = 1,
	chance = 1,
	action = function(pos, node)
		...
		if is_powered then
			if node.name == "moontest_mesecons_torch:mesecon_torch_on" then
				minetest.swap_node(pos, {name = "moontest_mesecons_torch:mesecon_torch_off", param2 = node.param2})
				mesecon.receptor_off(pos, torch_get_output_rules(node))
			end
		elseif node.name == "moontest_mesecons_torch:mesecon_torch_off" then
			minetest.swap_node(pos, {name = "moontest_mesecons_torch:mesecon_torch_on", param2 = node.param2})
