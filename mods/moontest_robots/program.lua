...
local function check_condition_variable (program)
	...
	if cmd.command == "moontest_robots:cmd_cond_value_less" then
		if utils.is_number_item (cmdstr (cmd)) or
			utils.is_variable_item (cmdstr (cmd)) then
	...
	elseif cmd.command == "moontest_robots:cmd_cond_value_greater" then
		if utils.is_number_item (cmdstr (cmd)) or
			utils.is_variable_item (cmdstr (cmd)) then
	...
	else -- assume moontest_robots:cmd_cond_value_equal
...
{
	["moontest_robots:cmd_cond_detect_front"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_front_down"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_front_up"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_back"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_back_down"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_back_up"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_down"] = check_condition_detect,
	["moontest_robots:cmd_cond_detect_up"] = check_condition_detect,
	["moontest_robots:cmd_cond_fits"] = check_condition_fits,
	["moontest_robots:cmd_cond_contains"] = check_condition_contains,
	["moontest_robots:cmd_cond_counter_equal"] = check_condition_counter,
	["moontest_robots:cmd_cond_counter_greater"] = check_condition_counter,
	["moontest_robots:cmd_cond_counter_less"] = check_condition_counter,
	["moontest_robots:cmd_cond_counter_even"] = check_condition_counter_even,
	["moontest_robots:cmd_cond_counter_odd"] = check_condition_counter_odd,
	["moontest_robots:cmd_cond_value_equal"] = check_condition_variable,
	["moontest_robots:cmd_cond_value_greater"] = check_condition_variable,
	["moontest_robots:cmd_cond_value_less"] = check_condition_variable,
	["moontest_robots:cmd_cond_value_even"] = check_condition_variable_even,
	["moontest_robots:cmd_cond_value_odd"] = check_condition_variable_odd,
	["moontest_robots:cmd_value_number"] = check_condition_number,
	["moontest_robots:cmd_value_text"] = check_condition_text,
	["moontest_robots:cmd_value_variable"] = check_condition_variable_value,
	["moontest_robots:cmd_name_front"] = check_condition_name,
	["moontest_robots:cmd_name_front_down"] = check_condition_name,
	["moontest_robots:cmd_name_front_up"] = check_condition_name,
	["moontest_robots:cmd_name_back"] = check_condition_name,
	["moontest_robots:cmd_name_back_down"] = check_condition_name,
	["moontest_robots:cmd_name_back_up"] = check_condition_name,
	["moontest_robots:cmd_name_down"] = check_condition_name,
	["moontest_robots:cmd_name_up"] = check_condition_name,
}
...
local function check_condition (program, last_condition)
	...
	while true do
		...
		if cmd.command == "moontest_robots:cmd_op_not" then
			must_follow = true
			can_and_or = false
			last_condition = "not"

		elseif cmd.command == "moontest_robots:cmd_op_and" then
		...
		elseif cmd.command == "moontest_robots:cmd_op_or" then
			if not can_and_or then
...
local check_table =
{
	["moontest_robots:cmd_act_dig_front"] = check_dig,
	["moontest_robots:cmd_act_dig_front_down"] = check_dig,
	["moontest_robots:cmd_act_dig_front_up"] = check_dig,
	["moontest_robots:cmd_act_dig_back"] = check_dig,
	["moontest_robots:cmd_act_dig_back_down"] = check_dig,
	["moontest_robots:cmd_act_dig_back_up"] = check_dig,
	["moontest_robots:cmd_act_dig_down"] = check_dig,
	["moontest_robots:cmd_act_dig_up"] = check_dig,
	["moontest_robots:cmd_act_move_back"] = check_move,
	["moontest_robots:cmd_act_move_down"] = check_move,
	["moontest_robots:cmd_act_move_front"] = check_move,
	["moontest_robots:cmd_act_move_up"] = check_move,
	["moontest_robots:cmd_act_turn_left"] = check_turn,
	["moontest_robots:cmd_act_turn_right"] = check_turn,
	["moontest_robots:cmd_act_pull"] = check_pull,
	["moontest_robots:cmd_act_put"] = check_put,
	["moontest_robots:cmd_act_pull_stack"] = check_pull_stack,
	["moontest_robots:cmd_act_put_stack"] = check_put_stack,
	["moontest_robots:cmd_act_drop"] = check_drop,
	["moontest_robots:cmd_act_trash"] = check_trash,
	["moontest_robots:cmd_act_drop_stack"] = check_drop_stack,
	["moontest_robots:cmd_act_trash_stack"] = check_trash_stack,
	["moontest_robots:cmd_act_place_front"] = check_place,
	["moontest_robots:cmd_act_place_front_down"] = check_place,
	["moontest_robots:cmd_act_place_front_up"] = check_place,
	["moontest_robots:cmd_act_place_back"] = check_place,
	["moontest_robots:cmd_act_place_back_down"] = check_place,
	["moontest_robots:cmd_act_place_back_up"] = check_place,
	["moontest_robots:cmd_act_place_down"] = check_place,
	["moontest_robots:cmd_act_place_up"] = check_place,
	["moontest_robots:cmd_act_craft"] = check_craft,
	["moontest_robots:cmd_value_number"] = check_number,
	["moontest_robots:cmd_value_text"] = check_text,
	["moontest_robots:cmd_value_variable"] = check_variable,
	["moontest_robots:cmd_name_front"] = check_name,
	["moontest_robots:cmd_name_front_down"] = check_name,
	["moontest_robots:cmd_name_front_up"] = check_name,
	["moontest_robots:cmd_name_back"] = check_name,
	["moontest_robots:cmd_name_back_down"] = check_name,
	["moontest_robots:cmd_name_back_up"] = check_name,
	["moontest_robots:cmd_name_down"] = check_name,
	["moontest_robots:cmd_name_up"] = check_name,
	["moontest_robots:cmd_act_stop"] = check_stop,
	["moontest_robots:cmd_act_wait"] = check_wait,
	["moontest_robots:cmd_act_chat"] = check_chat,
	["moontest_robots:cmd_act_value_assign"] = check_action_value_assign,
	["moontest_robots:cmd_act_value_plus"] = check_action_value_plus,
	["moontest_robots:cmd_act_value_minus"] = check_action_value_no_text,
	["moontest_robots:cmd_act_value_multiply"] = check_action_value_no_text,
	["moontest_robots:cmd_act_value_divide"] = check_action_value_no_text,
	["moontest_robots:cmd_stat_if"] = check_if,
	["moontest_robots:cmd_stat_loop"] = check_loop,
	["moontest_robots:cmd_op_or"] = check_or,
	["moontest_robots:cmd_op_not"] = check_not,
	["moontest_robots:cmd_op_and"] = check_and,
...
local function run_condition_detect (program, robot_pos)
	...
	local side = "front" -- assume moontest_robots:cmd_cond_detect_front

	if cmd.command == "moontest_robots:cmd_cond_detect_back" then
		side = "back"
	elseif cmd.command == "moontest_robots:cmd_cond_detect_back_down" then
		side = "back down"
	elseif cmd.command == "moontest_robots:cmd_cond_detect_back_up" then
		side = "back up"
	elseif cmd.command == "moontest_robots:cmd_cond_detect_down" then
		side = "down"
	elseif cmd.command == "moontest_robots:cmd_cond_detect_up" then
		side = "up"
	elseif cmd.command == "moontest_robots:cmd_cond_detect_front_down" then
		side = "front down"
	elseif cmd.command == "moontest_robots:cmd_cond_detect_front_up" then
		side = "front up"
	end
...
local function run_condition_counter (program, robot_pos)
	...
	if cmd.command == "moontest_robots:cmd_cond_counter_less" then
		return program:loop_counter () < value

	elseif cmd.command == "moontest_robots:cmd_cond_counter_greater" then
		return program:loop_counter () > value

	else -- assume moontest_robots:cmd_cond_counter_equal
		return program:loop_counter () == value
...
{
	["moontest_robots:cmd_cond_detect_front"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_front_down"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_front_up"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_back"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_back_down"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_back_up"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_down"] = run_condition_detect,
	["moontest_robots:cmd_cond_detect_up"] = run_condition_detect,
	["moontest_robots:cmd_cond_fits"] = run_condition_fits,
	["moontest_robots:cmd_cond_contains"] = run_condition_contains,
	["moontest_robots:cmd_cond_counter_equal"] = run_condition_counter,
	["moontest_robots:cmd_cond_counter_greater"] = run_condition_counter,
	["moontest_robots:cmd_cond_counter_less"] = run_condition_counter,
	["moontest_robots:cmd_cond_counter_even"] = run_condition_counter_even,
	["moontest_robots:cmd_cond_counter_odd"] = run_condition_counter_odd,
	["moontest_robots:cmd_cond_value_equal"] = run_condition_variable,
	["moontest_robots:cmd_cond_value_greater"] = run_condition_variable,
	["moontest_robots:cmd_cond_value_less"] = run_condition_variable,
	["moontest_robots:cmd_cond_value_even"] = run_condition_variable_even,
	["moontest_robots:cmd_cond_value_odd"] = run_condition_variable_odd,
}
...
local function get_node_name (command, robot_pos)
	local side = "front" -- assume moontest_robots:cmd_name_front

	if command == "moontest_robots:cmd_name_back" then
		side = "back"
	elseif command == "moontest_robots:cmd_name_back_down" then
		side = "back down"
	elseif command == "moontest_robots:cmd_name_back_up" then
		side = "back up"
	elseif command == "moontest_robots:cmd_name_down" then
		side = "down"
	elseif command == "moontest_robots:cmd_name_up" then
		side = "up"
	elseif command == "moontest_robots:cmd_name_front_down" then
		side = "front down"
	elseif command == "moontest_robots:cmd_name_front_up" then
		side = "front up"
	end
...
local function run_dig (program, robot_pos)
	local cmd = program:cur_command ()
	local side = "front" -- assume moontest_robots:cmd_act_dig_front

	if cmd.command == "moontest_robots:cmd_act_dig_back" then
		side = "back"
	elseif cmd.command == "moontest_robots:cmd_act_dig_back_down" then
		side = "back down"
	elseif cmd.command == "moontest_robots:cmd_act_dig_back_up" then
		side = "back up"
	elseif cmd.command == "moontest_robots:cmd_act_dig_down" then
		side = "down"
	elseif cmd.command == "moontest_robots:cmd_act_dig_up" then
		side = "up"
	elseif cmd.command == "moontest_robots:cmd_act_dig_front_down" then
		side = "front down"
	elseif cmd.command == "moontest_robots:cmd_act_dig_front_up" then
		side = "front up"
	end
...
local function run_move (program, robot_pos)
	local cmd = program:cur_command ()
	local side = "front" -- assume moontest_robots:cmd_act_move_front

	if cmd.command == "moontest_robots:cmd_act_move_back" then
		side = "back"
	elseif cmd.command == "moontest_robots:cmd_act_move_down" then
		side = "down"
	elseif cmd.command == "moontest_robots:cmd_act_move_up" then
		side = "up"
	end
...
local function run_turn (program, robot_pos)
	local cmd = program:cur_command ()
	local side = "left" -- assume moontest_robots:cmd_act_turn_left

	if cmd.command == "moontest_robots:cmd_act_turn_right" then
		side = "right"
	end
...
local function run_place (program, robot_pos)
	local cmd = program:cur_command ()
	local item = program:next_cell ()
	local side = "front" -- assume moontest_robots:cmd_act_place_front

	if cmd.command == "moontest_robots:cmd_act_place_back" then
		side = "back"
	elseif cmd.command == "moontest_robots:cmd_act_place_back_down" then
		side = "back down"
	elseif cmd.command == "moontest_robots:cmd_act_place_back_up" then
		side = "back up"
	elseif cmd.command == "moontest_robots:cmd_act_place_down" then
		side = "down"
	elseif cmd.command == "moontest_robots:cmd_act_place_up" then
		side = "up"
	elseif cmd.command == "moontest_robots:cmd_act_place_front_down" then
		side = "front down"
	elseif cmd.command == "moontest_robots:cmd_act_place_front_up" then
		side = "front up"
	end
...
local run_table =
{
	["moontest_robots:cmd_act_dig_front"] = run_dig,
	["moontest_robots:cmd_act_dig_front_down"] = run_dig,
	["moontest_robots:cmd_act_dig_front_up"] = run_dig,
	["moontest_robots:cmd_act_dig_back"] = run_dig,
	["moontest_robots:cmd_act_dig_back_down"] = run_dig,
	["moontest_robots:cmd_act_dig_back_up"] = run_dig,
	["moontest_robots:cmd_act_dig_down"] = run_dig,
	["moontest_robots:cmd_act_dig_up"] = run_dig,
	["moontest_robots:cmd_act_move_back"] = run_move,
	["moontest_robots:cmd_act_move_down"] = run_move,
	["moontest_robots:cmd_act_move_front"] = run_move,
	["moontest_robots:cmd_act_move_up"] = run_move,
	["moontest_robots:cmd_act_turn_left"] = run_turn,
	["moontest_robots:cmd_act_turn_right"] = run_turn,
	["moontest_robots:cmd_act_pull"] = run_pull,
	["moontest_robots:cmd_act_put"] = run_put,
	["moontest_robots:cmd_act_pull_stack"] = run_pull_stack,
	["moontest_robots:cmd_act_put_stack"] = run_put_stack,
	["moontest_robots:cmd_act_drop"] = run_drop,
	["moontest_robots:cmd_act_trash"] = run_trash,
	["moontest_robots:cmd_act_drop_stack"] = run_drop_stack,
	["moontest_robots:cmd_act_trash_stack"] = run_trash_stack,
	["moontest_robots:cmd_act_place_front"] = run_place,
	["moontest_robots:cmd_act_place_front_down"] = run_place,
	["moontest_robots:cmd_act_place_front_up"] = run_place,
	["moontest_robots:cmd_act_place_back"] = run_place,
	["moontest_robots:cmd_act_place_back_down"] = run_place,
	["moontest_robots:cmd_act_place_back_up"] = run_place,
	["moontest_robots:cmd_act_place_down"] = run_place,
	["moontest_robots:cmd_act_place_up"] = run_place,
	["moontest_robots:cmd_act_craft"] = run_craft,
	["moontest_robots:cmd_act_stop"] = run_stop,
	["moontest_robots:cmd_act_wait"] = run_wait,
	["moontest_robots:cmd_act_chat"] = run_chat,
	["moontest_robots:cmd_act_value_assign"] = run_action_value_assign,
	["moontest_robots:cmd_act_value_plus"] = run_action_value_plus,
	["moontest_robots:cmd_act_value_minus"] = run_action_value_minus,
	["moontest_robots:cmd_act_value_multiply"] = run_action_value_multiply,
	["moontest_robots:cmd_act_value_divide"] = run_action_value_divide,
	["moontest_robots:cmd_stat_if"] = run_if,
	["moontest_robots:cmd_stat_loop"] = run_loop,
